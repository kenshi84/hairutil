...
void getroots(args::Subparser &parser);
void gettips(args::Subparser &parser);
...
std::shared_ptr<cyHairFile> getroots(std::shared_ptr<cyHairFile> hairfile_in);
std::shared_ptr<cyHairFile> gettips(std::shared_ptr<cyHairFile> hairfile_in);
